        ...
        <div className="bg-[#f3edf9] p-10">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4 mt-2 text-gray-800">
                            <span className="w-6 h-6 cursor-pointer hover:text-gray-500"><FaFacebookF size={24} /></span>
                            <span className="w-6 h-6 cursor-pointer hover:text-gray-500"><FaPinterestP size={24} /></span>
                            <span className="w-6 h-6 cursor-pointer hover:text-gray-500"><FaLinkedinIn size={24} /></span>
                            <span className="w-6 h-6 cursor-pointer hover:text-gray-500"><FaSkype size={24} /></span>
                        </div>
                ...
                <div>
                    <iframe
                        title="Google Map"
                        className="w-full h-[380px] rounded-lg shadow-lg"
